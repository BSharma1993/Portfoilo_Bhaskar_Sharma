...
const MyModal = ({ CloseModal }) => {
  ...
  return (
    <>
      <div
        className=" fixed left-0 right-0 bottom-0 top-0 z-10 bg-[#202020]"
        onClick={CloseModal}
      >
        <div className=" bg-[#191919] max-w-6xl rounded-2xl max-h-fit container mx-auto flex flex-col items-center justify-center mt-[70px] ">
          <h1 className="text-[#4077b1] md:mt-6 text-3xl font-bold uppercase">
            About Me
          </h1>
          <div className=" flex flex-col md:flex-row ">
            <div className=" m-5 md:m-0 md:ml-10 md:w-[450px] text-slate-500 font-semibold text-xs text-justify lg:text-lg order-2 lg:order-1">
              <p className=" md:mt-5">
              ...
              <h1 className=" mt-5 text-[#4077b1] text-3xl font-bold">
                MERN STACK
              </h1>
              <div className=" relative mt-12 md:mt-16 md:ml-16 mb-5 cursor-default">
                <div className=" flex items-center text-xl space-x-12">
                  <div className=" flex flex-col items-center justify-center">
                    <img src={mongodb} alt="mongodb" />
                    <span className=" mt-5 font-semibold text-[#47a248]">
                      M
                    </span>
                    <div className=" absolute text-xl items-center opacity-0 hover:-top-14 hover:opacity-100 text-white py-1 px-3 rounded-full bg-[#47a248] ">
                      <div className=" absolute w-4 h-4 rotate-45 left-[50px] top-8 bg-inherit"></div>
                      <span className=" relative ">mongoDB</span>
                    </div>
                  </div>
                  <div className=" flex flex-col items-center justify-center">
                    <div className="absolute text-xl items-center opacity-0 hover:-top-14 hover:opacity-100 text-black py-1 px-3 rounded-full bg-[#fdfdfd]">
                      <div className=" absolute w-4 h-4 rotate-45 left-[50px] top-8 bg-inherit"></div>
                      <span className=" relative ">Express.js</span>
                    </div>
                    <img src={express} alt="express" />
                    <span className=" mt-5 font-semibold text-white">E</span>
                  </div>
                  <div className=" flex flex-col items-center justify-center">
                    <img src={react} alt="react" />
                    <span className=" mt-5 font-semibold text-[#61dafb]">
                      R
                    </span>
                    <div className="absolute text-xl items-center opacity-0 hover:-top-14 hover:opacity-100 text-black py-1 px-3 rounded-full bg-[#61dafb]">
                      <div className=" absolute w-4 h-4 rotate-45 left-[40px] top-8 bg-inherit"></div>
                      <span className=" relative ">React.js</span>
                    </div>
                  </div>
                  <div className=" flex flex-col items-center justify-center">
                    <img src={node} alt="node" />
                    <span className=" mt-5 font-semibold text-[#8cc84b]">
                      N
                    </span>
                    <div className="absolute text-xl items-center opacity-0 hover:-top-14 hover:opacity-100 text-black py-1 px-3 rounded-full bg-[#8cc84b]">
                      <div className=" absolute w-4 h-4 rotate-45 left-[39px] top-8 bg-inherit"></div>
            ...
            <div className="order-1 ml-28 md:ml-0 w-[150px] md:w-[600px] md:h-[500px] ">
              <svg
                width=""
                height=""
                viewBox="0 0 900 600"
          ...
          <button
            onClick={CloseModal}
            className=" hidden md:block absolute top-[75px] right-[195px] hover:scale-110 duration-200 rounded-full bg-gradient-to-l from-[#1595b6] to-[#1f2667e6] text-white p-2 text-xl lg:px-2 lg:py-2 lg:text-3xl"
          >
            <IoClose />
          </button>
        </div>
